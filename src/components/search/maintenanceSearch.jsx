        ...
        <div>
            <div className='search-main-container'>
                ...
                <div className='search-item-container'>
                    ...
                    <Calendar id="maintenanceStartDate" className='txt-search-item maintenance-date' value={maintenanceStartDate} onChange={(e) => setMaintenanceStartDate(e.value)} showButtonBar />
                    <label className='lbl-search-item' htmlFor="maintenanceEndDate"> {t('api.maintenance.maintenanceEndDate')} </label>
                    <Calendar id="maintenanceEndDate" className='txt-search-item maintenance-date' value={maintenanceEndDate} onChange={(e) => setMaintenanceEndDate(e.value)} showButtonBar />
                </div>
